    ...
    <div class="footer-main-wrapper">
            ...
            <div style="display: flex; gap: 20px; width: 100%">
                ...
                <div class="right-col-wrapper">
                        ...
                        <div class="links-list-wrapper tech-support">
                            ...
                            <ul class="links-list-wrapper">
                                <li><a class="footer-main__link group-link-item"
                                    ...
                                    <img src="/v3/docs/assets/github.svg" loading="lazy" alt="github icon" width="25"
                                         height="25"/>
                                    <span>Форум</span>
                                </a></li>
                                <li><a class="footer-main__link group-link-item"
                                ...
                                <li><a class="footer-main__link group-link-item" href="mailto:support@green-api.com"
                                       target="_blank" rel="noreferrer">
                                    <img src="/v3/docs/assets/email.svg" loading="lazy" alt="email icon" width="25"
                                         height="25"/>
                                    <span>support@green-api.com</span>
                                </a></li>
                                <li><a class="footer-main__link group-link-item" href="https://wa.me/77780739095"
                                       target="_blank" rel="noreferrer">
                                    <img src="/v3/docs/assets/whatsapp.svg" loading="lazy" alt="whatsapp icon" width="25"
                                         height="25"/>
                                ...
                                <li><a class="footer-main__link group-link-item"
                                       ...
                                       target="_blank" rel="noreferrer">
                                    <img src="/v3/docs/assets/telegram.svg" loading="lazy" alt="telegram icon" width="25"
                                         height="25"/>
                                ...
                                <li><a class="footer-main__link group-link-item"
                                       ...
                                       target="_blank" rel="noreferrer">
                                    <img src="/v3/docs/assets/max.svg" loading="lazy" alt="max icon" width="25"
                                         height="25"/>
                        ...
                        <div class="mobile-apps">
                            <div class="mobile-apps-list">
                                <a href="https://play.google.com/store/apps/details?id=com.greenapi.console"
                                   target="_blank"
                                   rel="noreferrer">
                                    <img width="135" src="/v3/docs/assets/mobile-application/googleplay-ru-white.svg"
                                         alt="googlePlay"/>
                                </a>
                                <a href="https://www.rustore.ru/catalog/app/com.greenapi.console" target="_blank"
                                   rel="noreferrer">
                                    <img width="135" src="/v3/docs/assets/mobile-application/rustore-white.svg"
                                         alt="googlePlay"/>
                                </a>
                                <a
                                ...
                                >
                                    <img
                                            ...
                                            src="/v3/docs/assets/powered_green_api.svg"
                                    />
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="astana-hub-wrapper astana-hub-tech-support">
                        <img src="/v3/docs/assets/astana-hub.svg" width="182" alt="astana hub logo"/>
        ...
        <div class="footer-company-info-wrapper">
            <div class="mobile-apps-company-info">
                <div class="mobile-apps-list">
                    ...
                    <a href="https://www.rustore.ru/catalog/app/com.greenapi.console" target="_blank" rel="noreferrer">
                        <img width="135" src="/v3/docs/assets/mobile-application/rustore-white.svg" alt="googlePlay"/>
                    </a>
                    <a
                            href="https://green-api.com/"
                            class="footer-main__nav-link footer-main__group-links-item"
            ...
            <div class="footer-social-list social-list-company-info">
                <div class="footer-social__item" title="WhatsApp">
                    ...
                    >
                        <span class="icon">
                          <img width="30" height="30" src="/v3/docs/assets/whatsappWhite.svg" alt="WhatsApp"/>
                        </span>
                    </a>
                </div>
                <div class="footer-social__item" title="Telegram">
                    ...
                    >
                        <span class="icon">
                          <img width="30" height="30" src="/v3/docs/assets/telegramWhite.svg" alt="Telegram"/>
                        </span>
                    </a>
                </div>
                <div class="footer-social__item" title="YouTube Канал">
                    ...
                    >
                        <span class="icon">
                          <img width="30" height="30" src="/v3/docs/assets/youtube.svg" alt="YouTube"/>
                        </span>
                    </a>
                </div>
                <div class="footer-social__item" title="RuTube Канал">
                    ...
                    >
                        <span class="icon">
                          <img width="30" height="30" src="/v3/docs/assets/rutube.svg" alt="RuTube"/>
                        </span>
                    </a>
                </div>
                <div class="footer-social__item" title="LinkedIn">
                    ...
                    >
                        <span class="icon">
                          <img width="30" height="30" src="/v3/docs/assets/linkedin.svg" alt="LinkedIn"/>
                        </span>
                    </a>
                </div>
                ...
                <!--          >-->
                <!--                        <span class="icon">-->
                <!--                          <img width="30" height="30" src="/v3/docs/assets/instagram.svg" alt="Instagram"/>-->
                <!--                        </span>-->
                <!--          </a>-->
                <!--        </div>-->
                ...
                <!--             rel="noreferrer">-->
                <!--                        <span class="icon">-->
                <!--                          <img width="30" height="30" src="/v3/docs/assets/facebook.svg" alt="Facebook"/>-->
                <!--                        </span>-->
                <!--          </a>-->
                <!--        </div>-->
                <div class="footer-social__item" title="Dzen">
                    ...
                    >
                        <span class="icon">
                          <img width="30" height="30" src="/v3/docs/assets/dzen.svg" alt="Dzen"/>
                        </span>
                    </a>
                </div>
                <div class="footer-social__item" title="VK">
                    ...
                    >
                        <span class="icon">
                          <img width="30" height="30" src="/v3/docs/assets/vk.svg" alt="VK"/>
                        </span>
                    </a>
                </div>
            </div>
        ...
        <div class="footer-payments">
            ...
            <div class="payments-list">
                <img src="/v3/docs/assets/pay/mirPayment.svg" width="54" height="20" alt="MIR">
                <img src="/v3/docs/assets/pay/mirAcceptPayment.svg" width="36" height="20" alt="MIRAccept">
                <img src="/v3/docs/assets/pay/visaPayment.svg" width="46" height="20" alt="VISA">
                <img src="/v3/docs/assets/pay/visaVerifiedPayment.svg" width="34" height="20" alt="verified by visa">
                <img src="/v3/docs/assets/pay/mastercardPayment.svg" width="29" height="30" alt="mastercard">
                <img src="/v3/docs/assets/pay/masterCardSecureCodePayment.svg" width="40" height="20"
